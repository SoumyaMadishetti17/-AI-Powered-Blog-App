                ...
                <form onSubmit={handleSubmit} className='w-full mt-6 sm:max-w-md text-gray-600'>
                    <div className='flex flex-col'>
                        ...
                        <input
                            ...
                            className='p-2 border-b-2 border-gray-300 outline-none mb-6'
                        />
                    </div>
                    <div className='flex flex-col'>
                    ...
                    <button
                        type='button'
                        onClick={fillDemo}
                        className='w-full py-2 mb-3 text-sm font-medium text-primary border border-primary/40 rounded cursor-pointer hover:bg-primary/5 transition-all'
                    >
